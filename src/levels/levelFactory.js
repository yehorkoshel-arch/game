...
function makeLevels(locIdx){
  ...
  const lvivObs=[
    ['kiosk','bollard'],
    ['kiosk','bollard','tck','machinegun'],
    ['kiosk','bollard','tck','machinegun'],
    ['bollard','tck','kiosk','machinegun'],
    ['tck','bollard','kiosk','machinegun'],
    ['tck','tck','bollard','machinegun'],
    ['tck','kiosk','bollard','tck','machinegun'],
    ['tck','tck','bollard','kiosk','machinegun'],
    ['tck','tck','tck','bollard','machinegun'],
    ['tck','tck','kiosk','bollard','tck','machinegun'],
    ['tck','tck','tck','bollard','kiosk','machinegun'],
    ['tck','tck','tck','tck','bollard','machinegun'],
    ['tck','tck','tck','kiosk','tck','machinegun'],
    ['tck','tck','tck','tck','kiosk','machinegun'],
    ['tck','tck','tck','tck','tck','bollard','machinegun'],
    ['tck','tck','tck','tck','tck','machinegun'],
    ['tck','tck','tck','tck','tck','kiosk','machinegun'],
    ['tck','tck','tck','tck','tck','tck','machinegun'],
    ['tck','tck','tck','tck','tck','tck','bollard','machinegun'],
    ['tck','tck','tck','tck','tck','tck','tck','machinegun'],
  ];
