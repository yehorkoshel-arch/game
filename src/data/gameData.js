export const LANGS={
  uk:{sub:'вулицями столиці',play:'ГРАТИ',shop:'МАГАЗИН',settings:'⚙ НАЛАШТУВАННЯ',coins:'Монети',shopTitle:'Магазин скінів',back:'← Повернутись до меню',pts:'очок',left:'◀ Ліво',jump:'▲ Стрибок',slide:'▼ Слайд',right:'Право ▶',menu:'☰ Меню',caught:'СПІЙМАЛИ!',win:'ФІНІШУВАВ!',total:'Всього монет',earned:'Зароблено',score:'Рахунок',restart:'Тисни кнопку або клавішу для рестарту',pressAny:'Натисни будь-яку клавішу або кнопку',owned:'✓ Обрано',equip:'Одягнути',skins:[{name:'Школяр'},{name:'Ніндзя'},{name:'Козак'}],dist:'м до фінішу',winBonus:'Бонус фінішу',
    ...
    lvivLyrics:['Леви площу стережуть,','Львове мій!','Кава пахне крізь брук,','Теплий прибій!','Ратуша кличе над нами,','Ліхтарі горять,','На Ринку зорі між дахами,','Львів у серці звучить!']},
...
export const UI_TEXT={
  uk:{
    ...
    tutorialStart:'Погнали!',
    tutorialLoading:'Завантаження...',
    tutorialMove:'Міняй смугу, щоб обходити перешкоди.',
  ...
  en:{
    ...
    tutorialLoading:'Loading...',
    tutorialMove:'Change lanes to dodge obstacles.',
  ...
  de:{
    ...
    kyiv:'🇺🇦 Kiew',
    lviv:'🦁 Lemberg',
    tutorialTitle:'Training',
    tutorialStart:'Los geht’s!',
    tutorialLoading:'Laden...',
    tutorialMove:'Wechsle die Spur, um Hindernissen auszuweichen.',
  ...
  fr:{
    ...
    tutorialLoading:'Chargement...',
    tutorialMove:'Change de voie pour éviter les obstacles.',
  ...
  es:{
    ...
    tutorialTitle:'Tutorial',
    tutorialStart:'¡Vamos!',
    tutorialLoading:'Cargando...',
    tutorialMove:'Cambia de carril para esquivar obstáculos.',
